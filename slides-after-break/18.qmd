---
title: "444 Lecture 18"
subtitle: "O'Connor Chapter 5"
...
![Figure 5.3 from O'Connor's book. Look how small the fair basin is on the right!](cailin-fig-5_3.png){height=80%}
...
- And that's true even if different forms of market infrastructure would have produced different outcomes.
...
![Figure 5.5 from O'Connor's book. Those triangles aren't going to zero!](cailin-fig-5_5.png){height=80%}
...
- We're getting back here to things that would come up if we modeled each interaction as a negotiation over time.
